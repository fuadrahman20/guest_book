...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  background-attachment: fixed; /* Opsional: Membuat gambar tetap di tempat saat digulir 
...
.custom-container {
    ...
    .gambar-konten3 {
      ...
      top: 0;
      left: 0;
      z-index: 1; /* Untuk memastikan gambar3 menutupi gambar2 
    }*/
    ...
    <div class="font-semibold grid content-center text-left md:text-left col-span-5 md:col-span-3">
          ...
          <div class="text-2xl mt-2 text-black font-medium">
           ...
           <div class="flex justify-center md:justify-end mt-8">
            <button class="custom-button" onclick="window.location='{{ route('register') }}';">Mulai Daftar</button>
           </div>
